...
routes['POST']['/courses/add'] = 'Courses#add_course'
routes['GET']['/courses/destroy/<int:course_id>'] = 'Courses#confirm_delete'
routes['GET']['/courses/destroy/delete/<int:course_id>'] = 'Courses#destroy'
